...
\begin{document}
   ...
   \AtBeginSubsection[] {
    ...
    \frame{
        ...
        Probabilidade de o módulo de interface ir para o estado de
            erro:
        \begin{itemize}
            \item P=? [F si = 4] - 0.02497672
        \end{itemize}

        Probabilidade de o módulo de coleta ir para o estado de
            erro:
        \begin{itemize}
            \item P=? [F sc = 4] - 0.02382040
        \end{itemize}


        Probabilidade de algum dos dois módulos independentes falhar:
        \begin{itemize}
            \item $Pf_c + Pf_i - Pf_c*Pf_i = 0.048202165$
        \end{itemize}
    ...
    \frame{
        ...
        \begin{itemize}
        \item Dada a probabilidade de falha calculada com o PRISM,
            pode-se calcular que o sistema fica aproximadamente 34
                horas e 40 minutos indisponível por mês.

        \item Parte da chance de erro dos componentes é decorrente da
        instabilidade da rede e do servidor usados para prover o
        serviço.
        \end{itemize}
    }
